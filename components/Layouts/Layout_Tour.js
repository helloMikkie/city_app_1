...
export default function Layout_Project({children, link_Back,link_IBA, link_Service, link_Settings, link_Projects, link_Events, link_Tours, link_Exhibition, link_Favorits}) {
    ...
    return(
        ...
        ></NavNavigationMenu>
        <div>{children}</div>
        <NavFTabbbarMain variant="tours active"
