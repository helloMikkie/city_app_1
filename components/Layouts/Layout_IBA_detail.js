...
export default function Layout_IBA_Detail({children, link_Back, link_Service, link_Settings, link_Projects, link_Events, link_Tours, link_Exhibition, link_Favorits}){
